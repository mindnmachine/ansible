# Don't forget to customize the file according to your environment.(ie; folder names etc)
# '.txt' extension has been added otherwise udemy doesn't allow file upload, you  should remove that before placing the file in your project folder
...
controller.vm.synced_folder "/home/pravin/sandbox/ansible-learning/mountpoint", "/home/vagrant/ansible", type: "sshfs"
end
# LB 
